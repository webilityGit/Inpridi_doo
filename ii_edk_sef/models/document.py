...
############################
    ...
    def invoice_approve_on_sef(self, approver_notes):
     ...
     #   response_object = json.loads(response.text)
        _logger.info('!!!!!!!!! Approve   ---   Ovo je Response object = %s', response)
        ...
        if response.status_code != 200:
            ...
            _logger.info('!!!!!!!!! Approve   ---   Ovo je Response content = %s', response.content)
            response_object = json.loads(response.content)
        #    response_object = json2obj(response.content)
    ...
    def invoice_reject_on_sef(self, approver_notes):
        ...
        _logger.info('!!!!!!! ODGOVR SEF-a   ---   Ovo je Response  = %s, a ovo response Object =%s', response)
        response_object = json(response.content)
